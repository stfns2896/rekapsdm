...
if (isset($POST['simpan'])) {
	...
	$input	= mysqli_query($connect, "UPDATE pegawai SET id_pelatihan= '$id_pelatihan', nipp = '$nipp', nama_pegawai = '$nama_pegawai', lokasi_pegawai = '$lokasi_pegawai', substansi = '$substansi', kelas_jabatan = '$kelas_jabatan', jenis_kelamin = '$jenis_kelamin', durasi = '$durasi' WHERE  id_pegawai = '$id_pegawai'") or die (mysqli_error()) or die (mysqli_error());
