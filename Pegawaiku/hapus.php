...
if (isset($GET['id_pegawai'])) {
	...
	$cek	= mysqli_query($connect, "SELECT nipp from pegawai WHERE id_pegawai='$id_pegawai'" or die (mysqli_error());
	...
	if (mysqli_query ($cek) == 0) {
		...
		$del = ($connect, "DELETE FROM pegawai WHERE id_pegawai=$id_pegawai");
